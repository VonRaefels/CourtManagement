...
db.Cuadro.save({_id: idCuadros[0], _idUrba: idUrbas[0], name: 'Tenis'});
db.Cuadro.save({_id: idCuadros[1], _idUrba: idUrbas[0], name: 'Padel'});
db.Cuadro.save({_id: idCuadros[2], _idUrba: idUrbas[0], name: 'Squash'});
db.Cuadro.save({_id: idCuadros[3], _idUrba: idUrbas[1], name: 'Tenis'});
db.Cuadro.save({_id: idCuadros[4], _idUrba: idUrbas[2], name: 'Tenis'});
